...
const resources = {
  en: {
    translation: {
      ...
      review: "Review",
      reviewed: "Reviewed",
      notReviewed: "Waiting for Review",
      user: "User",
      password: "Password",
      ...
      filterByScreenshot: "Filter by screenshot",
      filter: "Filters",
  ...
  es: {
    translation: {
      ...
      filterByScreenshot: "Filtrar por captura",
      ...
      capture: "Capturar",
      sentToDoctor: "Captura enviada al doctor",
      withScreenshot: "Captura enviada",
      withoutScreenshot: "Captura no enviada",
    },
  },
};
