...
export default function AnalisisBox(): JSX.Element {
  ...
  return (
    <Box display={"flex"} flexDirection={"column"} width={"100%"} height={'100%'} sx={{backgroundColor: '#159194', borderRadius: '2%'}} >
    ...
    <Box sx={{backgroundColor: '#fff', borderRadius: '2%'}} margin={'3%'} >
      ...
      <Grid container display={'flex'} justifyContent={'space-between'} padding={'1%'}>
          <Grid item >
    ...
    <Grid container display={'flex'} justifyContent={'space-between'} alignItems={'center'} padding={'1%'}>
