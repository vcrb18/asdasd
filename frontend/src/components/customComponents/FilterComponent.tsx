        ...
        <>
                    ...
                    >
                      <ListItem key={state}>
                        ...
                        <Checkbox
                          ...
                          color="neutral"
                          variant={
                            metricsValue.includes(state) ? "outlined" : "plain"
                          }
                          onChange={(
                            event: React.ChangeEvent<HTMLInputElement>
                          ) => {
          ...
          >
            ...
            >
              ...
              <DialogContent>
                <Box marginY={"2%"}>
                  <Typography align="left" fontSize={"60%"}>
                    {t("from")}
                  </Typography>
                    ...
                    >
                      <ListItem key={metric}>
                        ...
                        <Checkbox
                          ...
                          color="neutral"
                          variant={
                            metricsValue.includes(metric) ? "outlined" : "plain"
                          }
                          onChange={(
                            event: React.ChangeEvent<HTMLInputElement>
                          ) => {
