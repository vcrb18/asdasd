...
const DiagnosisTypes = [
    'Trasado dentro de los limites',
    'Ritmo sinusal',
]

const DeletableBoxItem = ({ label, onDelete }: { label: string, onDelete: (item: string) => void }): JSX.Element => {
    //   const [hovered, setHovered] = useState(false);
      ...
      return (
        ...
        width={'10%'}
        >   
            <IconButton size='small' edge={'end'} onClick={handleDeleteClick} sx={{backgroundColor: "#e45c64"}}>
        ...
        <DialogContent>
            <Typography color={'#000000'}>Are you sure you want to delete {label}?</Typography>
        </DialogContent>
        <DialogActions>
